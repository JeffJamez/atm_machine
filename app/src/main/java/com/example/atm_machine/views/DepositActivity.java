...
public class DepositActivity extends AppCompatActivity implements TransactionCallback {
    ...
    private void updateCurrentBalance() {
        ...
        tvCurrentBalance.setText("Current Balance: " + ValidationUtils.formatCurrency(balance));
    }
    ...
    private void showConfirmationDialog(double amount) {
        ...
        builder.setMessage("Are you sure you want to deposit " +
                ValidationUtils.formatCurrency(amount) + "?");
        builder.setPositiveButton("Confirm", (dialog, which) -> {
            showLoading(true);
            atmController.processDeposit(amount, this);
        });
